...
class CustomBottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: Listenable.merge([CartController(), WishlistController()]),
      builder: (context, child) {
        final int wishlistCount = WishlistController().items.length;
        final int cartCount = CartController().items.length;
