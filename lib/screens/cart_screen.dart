                  ...
                  child: cartItems.isEmpty
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              Icon(Icons.shopping_cart_outlined, size: 64, color: AppColors.navyBlue.withOpacity(0.1)),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 65,
            decoration: BoxDecoration(
              color: (item.product.bgColor ?? AppColors.lightGreen).withOpacity(0.08),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.shareTechMono(
                    color: currentStock == 0 ? Colors.red : AppColors.lightGreen,
                    fontSize: 9,
                    fontWeight: FontWeight.bold,
                  ),
                ),
